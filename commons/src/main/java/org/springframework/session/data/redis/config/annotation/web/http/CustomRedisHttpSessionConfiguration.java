...
import org.springframework.data.redis.listener.CustomRedisMessageListenerContainer;
import org.springframework.data.redis.listener.PatternTopic;
import org.springframework.data.redis.serializer.RedisSerializer;
import org.springframework.data.redis.serializer.StringRedisSerializer;
import org.springframework.scheduling.annotation.EnableScheduling;
import org.springframework.session.config.annotation.web.http.SpringHttpSessionConfiguration;
import org.springframework.session.data.redis.CustomRedisOperationsSessionRepository;
...
public class CustomRedisHttpSessionConfiguration extends SpringHttpSessionConfiguration
	...
	@Bean
	public CustomRedisMessageListenerContainer redisMessageListenerContainer(
			RedisConnectionFactory connectionFactory,
			CustomRedisOperationsSessionRepository messageListener) {

		CustomRedisMessageListenerContainer container = new CustomRedisMessageListenerContainer();
	...
	@Bean
	public CustomRedisOperationsSessionRepository sessionRepository(
			@Qualifier("sessionRedisTemplate") RedisOperations<Object, Object> sessionRedisTemplate,
			ApplicationEventPublisher applicationEventPublisher) {
		CustomRedisOperationsSessionRepository sessionRepository = new CustomRedisOperationsSessionRepository(
