 ...
 * @author Mark Paluch
 */
public class CustomRedisMessageListenerContainer implements InitializingBean, DisposableBean, BeanNameAware, SmartLifecycle {
	 ...
	 */
	public static final String DEFAULT_THREAD_NAME_PREFIX = ClassUtils.getShortName(CustomRedisMessageListenerContainer.class)
			+ "-";
	...
	private class SubscriptionTask implements SchedulingAwareRunnable {
		 ...
		 * 
		 * @author Thomas Darimont
		 * @see org.springframework.data.redis.listener.CustomRedisMessageListenerContainer.SubscriptionTask.SubscriptionPresentTestCondition
		 */
	 ...
	 * {@link org.springframework.data.redis.listener.CustomRedisMessageListenerContainer.SpinBarrier}
	 * 
	 * @author Jennifer Hickey
	 * @author Thomas Darimont Note: Placed here to avoid API exposure.
	 */
