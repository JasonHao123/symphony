...
import jason.app.symphony.touchid.comp.model.StatusRequest;
import jason.app.symphony.touchid.comp.model.StatusResponse;
 ...
 */
@Component
public class PreLoginStatusRouter extends RouteBuilder {

    @Override
    public void configure() throws Exception {

       rest("/status").description("Touch ID status service")
      .consumes("application/json")
      .produces("application/json")
      .get().description("perform login")
      .type(StatusRequest.class).description("login request")
      .outType(StatusResponse.class).description("login response")
      .responseMessage()
